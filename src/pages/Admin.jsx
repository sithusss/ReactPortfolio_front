...
try {
const res = await axios.get(`${process.env.REACT_APP_API_BASE_URL}/education`);
...
await axios.post(`${process.env.REACT_APP_API_BASE_URL}/education`, formData);
...
try {
// Handle only updates
await axios.put(`${process.env.REACT_APP_API_BASE_URL}/education/${editingId}`, formData);
...
try {
await axios.delete(`${process.env.REACT_APP_API_BASE_URL}/education/${id}`);
fetchEducations();
} catch (err) {
